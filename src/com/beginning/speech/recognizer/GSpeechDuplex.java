...
import com.beginning.speech.util.StringUtil;
...
public class GSpeechDuplex {
     ...
     * listeners.
     *
     * @paramURL you want to connect to.
     */
    ...
    private void openHttpsPostConnection(String murl , TargetDataLine mtl , int sampleRate) {
        ...
        try {
            ...
            System.out.println("Assistant Mode Activated!");
            tts.speak("Assistant Mode Activated!", 2.0f, true, true);
     ...
     */
    private synchronized void fireResponseEvent(GoogleResponse gr) throws IOException, URISyntaxException, SQLException, ClassNotFoundException {
